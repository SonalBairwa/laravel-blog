...
Route::get('admin/userRole', 'AdminController@userRole');
Route::POST('admin/assignRoleToUser', 'AdminController@assignRoleToUser');
Route::POST('admin/userWithRoles', 'AdminController@userWithRoles');
...
Route::post('/content/storeEditContent', 'AuthorController@storeEditContent');
